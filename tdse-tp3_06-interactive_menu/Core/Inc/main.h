...
#define Button_ENTER_Pin GPIO_PIN_2
...
#define Button_C_GPIO_Port GPIOA
...
#define Button_INCREASE_Pin GPIO_PIN_12
#define Button_INCREASE_GPIO_Port GPIOC
#define SWO_Pin GPIO_PIN_3
#define SWO_GPIO_Port GPIOB
#define Button_ESCAPE_Pin GPIO_PIN_7
#define Button_ESCAPE_GPIO_Port GPIOB
